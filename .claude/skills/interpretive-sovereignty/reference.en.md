*[中文版 / Read in Chinese](reference.md)*

# Reference Frameworks and Resources

This file supplements [SKILL.md](SKILL.md), documenting the legal and international frameworks this skill relies on, for further verification or citation.
...
Proposed by the International Indigenous Data Sovereignty Interest Group under the Research Data Alliance, with four core principles:

- **Collective Benefit**: data use should bring collective benefit to Indigenous communities
- **Authority to Control**: Indigenous peoples retain control over their own data and cultural expression
- **Responsibility**: users bear responsibility for how they use the data
- **Ethics**: Indigenous peoples' rights and well-being take priority over the convenience of data use
...
- Proposed by Canada's First Nations Information Governance Centre: Ownership, Control, Access, Possession
- Emphasizes that Indigenous communities should retain full governance over data "about themselves"
...
Even if the user provides basic evidence, commercial use carries higher risk. It's worth additionally reminding the user to confirm whether the scope of their evidence actually covers commercial use, and encouraging them to confirm directly with Taiwan's Council of Indigenous Peoples or the local tribe/association.
