...
4. **Evidence provided → generation may proceed**, but the output must note: "Based on the user's stated claim, this content is authorized by [stated evidence]." This is a reminder that this rests on the user's claim, not on verification by Claude.
